...
function injectExtensionPanel() {
  ...
  panel.innerHTML = `
      ...
      <div class="bs-logo-header">
        ...
        <div class="bs-section-toggles">
          <div class="bs-toggle-item">
            <label class="bs-toggle-label" for="bs-flight-toggle">Flight</label>
          ...
          <div class="bs-toggle-item">
            <label class="bs-toggle-label" for="bs-hotel-toggle">Hotel</label>
            <label class="bs-toggle-switch">
    ...
    <div class="bs-section" id="bs-flight-section">
      ...
      <div class="bs-inputs-grid">
        <div class="bs-input-group">
          <label>From</label>
          <input type="text" id="bs-flight-from" placeholder="City or airport" autocomplete="off" autocapitalize="characters" spellcheck="false" inputmode="text" />
        </div>
        ...
        <div class="bs-input-group">
          <label>To</label>
          <input type="text" id="bs-flight-to" placeholder="City or airport" autocomplete="off" autocapitalize="characters" spellcheck="false" inputmode="text" />
        </div>
        <div class="bs-input-group">
          <label>Depart</label>
      ...
      <div class="bs-buttons-grid" id="bs-external-links" style="display:none;">
        <button class="bs-btn bs-btn-google-flights" data-service="google-flights" title="Google Flights">
          <img src="" data-btn-image="GoogleFlights" alt="Google Flights" class="bs-btn-icon" width="20" height="20" />
        </button>
        <button class="bs-btn bs-btn-points-yeah" data-service="points-yeah" title="PointsYeah">
          <img src="" data-btn-image="PointsYeah" alt="PointsYeah" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-award-tool" data-service="award-tool" title="AwardTool">
          <img src="" data-btn-image="AwardTool" alt="AwardTool" class="bs-btn-icon" />
        ...
        <button class="bs-btn bs-btn-seats-aero" data-service="seats-aero" title="Seats.Aero">
          <img src="" data-btn-image="Seats.Aero" alt="Seats.Aero" class="bs-btn-icon bs-btn-logo" />
          <span class="bs-seats-aero-label">Seats.Aero</span>
        </button>
        <button class="bs-btn bs-btn-point-me" data-service="point-me" title="Point.me">
          <img src="" data-btn-image="Point.me" alt="Point.me" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-kayak" data-service="kayak" title="Kayak">
          <img src="" data-btn-image="Kayak" alt="Kayak" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-skyscanner" data-service="skyscanner" title="Skyscanner">
          <img src="" data-btn-image="Skyscanner" alt="Skyscanner" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-air-canada" data-service="air-canada" title="Air Canada">
          <img src="" data-btn-image="AirCanada" alt="Air Canada" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-united" data-service="united" title="United">
          <img src="" data-btn-image="United" alt="United" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-virgin-atlantic" data-service="virgin-atlantic" title="Virgin Atlantic">
          <img src="" data-btn-image="VirginAtlantic" alt="Virgin Atlantic" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-miles-and-more" data-service="miles-and-more" title="Miles & More">
          <img src="" data-btn-image="MilesAndMore" alt="Miles & More" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-rovemiles" data-service="rovemiles" title="RoveMiles">
          <img src="" data-btn-image="RoveMiles" alt="RoveMiles" class="bs-btn-icon bs-btn-logo bs-rovemiles-logo" />
          RoveMiles
        </button>
        <button class="bs-btn bs-btn-fare-class" data-service="fare-class" title="Fare Class">
          <img src="" data-btn-image="FareClass" alt="Fare Class" class="bs-btn-icon bs-btn-logo" />
          Fare Class
        </button>
        <button class="bs-btn bs-btn-flight-connections" data-service="flight-connections" title="Connections">
          <img src="" data-btn-image="Connections" alt="Connections" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-turbli" data-service="turbli" title="Turbli">
          <img src="" data-btn-image="Turbli" alt="Turbli" class="bs-btn-icon bs-btn-logo" />
          Turbli
        </button>
        <button class="bs-btn bs-btn-roame" data-service="roame" title="Roame">
          <img src="" data-btn-image="Roame" alt="Roame" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-awardlogic" data-service="awardlogic" title="AwardLogic">
          <img src="" data-btn-image="AwardLogic" alt="AwardLogic" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-pointhound" data-service="pointhound" title="Pointhound">
          <img src="" data-btn-image="Pointhound" alt="Pointhound" class="bs-btn-icon bs-btn-logo" />
        </button>
    ...
    <div class="bs-section" id="bs-hotel-section" style="display: none;">
      ...
      <div class="bs-inputs-grid">
        <div class="bs-input-group">
          <label>City</label>
          <input type="text" id="bs-hotel-city" placeholder="City" autocomplete="off" autocapitalize="words" spellcheck="false" inputmode="text" />
        </div>
        <div class="bs-input-group">
        ...
        <div class="bs-input-group">
          <label>Adults</label>
          <input type="number" id="bs-hotel-adults" min="1" value="2" inputmode="numeric" />
        </div>
        <div class="bs-input-group">
          <label>Rooms</label>
          <input type="number" id="bs-hotel-rooms" min="1" value="1" inputmode="numeric" />
        </div>
      </div>
      ...
      <div class="bs-buttons-grid" id="bs-hotel-external-links" style="display:none;">
        <button class="bs-btn bs-btn-google-hotels" data-service="google-hotels" title="Google Hotels">
          <img src="" data-btn-image="GoogleHotels" alt="Google Hotels" class="bs-btn-icon" width="20" height="20" />
        </button>
        <button class="bs-btn bs-btn-rooms-aero" data-service="rooms-aero" title="rooms.aero">
          <img src="" data-btn-image="Seats.Aero" alt="rooms.aero" class="bs-btn-icon bs-btn-logo" />
          <span class="bs-rooms-aero-label">rooms.aero</span>
        </button>
        ...
        <button class="bs-btn bs-btn-maxmypoint" data-service="maxmypoint" title="MaxMyPoint">
          <img src="" data-btn-image="MaxMyPoint" alt="MaxMyPoint" class="bs-btn-icon" />
          <span class="bs-maxmypoint-label">MaxMyPoint</span>
        </button>
        <button class="bs-btn bs-btn-awayz" data-service="awayz-hotels" title="Awayz">
          <img src="" data-btn-image="Awayz" alt="Awayz" class="bs-btn-icon bs-btn-logo bs-awayz-logo" />
        </button>
        <button class="bs-btn bs-btn-gondola" data-service="gondola-hotels" title="Gondola">
          <img src="" data-btn-image="Gondola" alt="Gondola" class="bs-btn-icon bs-btn-logo bs-gondola-logo" />
        </button>
        <button class="bs-btn bs-btn-hyatt" data-service="hyatt" title="Hyatt">
          <img src="" data-btn-image="Hyatt" alt="Hyatt" class="bs-btn-icon bs-btn-logo bs-hyatt-logo" />
        </button>
        <button class="bs-btn bs-btn-wyndham" data-service="wyndham" title="Wyndham">
          <img src="" data-btn-image="Wyndham" alt="Wyndham Rewards" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-iprefer" data-service="iprefer" title="iPrefer">
          <img src="" data-btn-image="iPrefer" alt="iPrefer" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-choice" data-service="choice" title="Choice">
          <img src="" data-btn-image="Choice" alt="Choice" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-preferred-hotels" data-service="preferred-hotels" title="Preferred">
          <img src="" data-btn-image="Preferred" alt="Preferred" class="bs-btn-icon bs-btn-logo" />
        </button>
        <button class="bs-btn bs-btn-hilton" data-service="hilton" title="Hilton">
          <img src="" data-btn-image="Hilton" alt="Hilton" class="bs-btn-icon bs-btn-logo bs-btn-logo-lg" />
        </button>
        <button class="bs-btn bs-btn-marriott" data-service="marriott-lounges" title="Marriott">
          <img src="" data-btn-image="Marriott" alt="Marriott" class="bs-btn-icon bs-btn-logo bs-btn-logo-lg bs-marriott-logo" />
        </button>
        <button class="bs-btn bs-btn-melia" data-service="melia" title="Melia">
          <img src="" data-btn-image="Melia" alt="Melia" class="bs-btn-icon bs-melia-logo" />
        </button>
        ...
        <button class="bs-btn bs-btn-gha" data-service="gha" title="GHA">
          <img src="" data-btn-image="GHA" alt="GHA" class="bs-btn-icon bs-btn-logo-lg bs-gha-logo" />
        </button>
        <button class="bs-btn bs-btn-lhw" data-service="lhw" title="Leading Hotels of the World">
          <img src="" data-btn-image="LHW" alt="LHW" class="bs-btn-icon bs-btn-logo-lg" />
        </button>
      </div>
    </div>
  ...
  // Button pictures: always use local images from extension images/ folder (same sizes/classes unchanged)
  if (typeof chrome !== 'undefined' && chrome.runtime && chrome.runtime.getURL) {
    const btnImgs = panel.querySelectorAll('img[data-btn-image]');
    btnImgs.forEach(function (img) {
      const name = img.getAttribute('data-btn-image');
      // Use the raw name so it matches filenames like "Google Flights.png"
      // Chrome will handle URL-encoding spaces and special characters.
      if (name) img.src = chrome.runtime.getURL('images/' + name + '.png');
    });
  }
  ...
  setTimeout(() => {
    ...
    // Mobile: show Depart/Return and Check-in/Check-out in European format (DD.MM.YYYY)
    setupMobileEuropeanDateInputs();
  }, 100);
}

/** Format YYYY-MM-DD to DD.MM.YYYY (European) */
function formatDateToEuropean(iso) {
  if (!iso || !/^\d{4}-\d{2}-\d{2}$/.test(iso)) return '';
  const [y, m, d] = iso.split('-');
  return d + '.' + m + '.' + y;
}

/** Update the European-date display span for one input (mobile only). */
function updateMobileDateDisplay(inputId) {
  const input = document.getElementById(inputId);
  if (!input) return;
  const wrap = input.closest('.bs-date-wrap');
  if (!wrap) return;
  const span = wrap.querySelector('.bs-date-euro');
  if (!span) return;
  const iso = input.value || '';
  span.textContent = iso ? formatDateToEuropean(iso) : '';
  span.classList.toggle('bs-date-euro-empty', !iso);
}

/** Call after programmatically setting date input values (e.g. restore) so mobile display updates. */
function bsUpdateMobileDateDisplays() {
  if (!window.matchMedia('(max-width: 768px)').matches) return;
  ['bs-flight-depart', 'bs-flight-return', 'bs-hotel-checkin', 'bs-hotel-checkout'].forEach(updateMobileDateDisplay);
}

/** Wrap date inputs and show European format on mobile. */
function setupMobileEuropeanDateInputs() {
  if (!window.matchMedia('(max-width: 768px)').matches) return;
  const ids = ['bs-flight-depart', 'bs-flight-return', 'bs-hotel-checkin', 'bs-hotel-checkout'];
  ids.forEach(function (id) {
    const input = document.getElementById(id);
    if (!input || input.closest('.bs-date-wrap')) return;
    const wrapper = document.createElement('div');
    wrapper.className = 'bs-date-wrap';
    const span = document.createElement('span');
    span.className = 'bs-date-euro bs-date-euro-empty';
    span.setAttribute('aria-hidden', 'true');
    input.parentNode.insertBefore(wrapper, input);
    wrapper.appendChild(input);
    wrapper.appendChild(span);
    updateMobileDateDisplay(id);
    input.addEventListener('input', function () { updateMobileDateDisplay(id); });
    input.addEventListener('change', function () { updateMobileDateDisplay(id); });
  });
  window.addEventListener('resize', function onResize() {
    if (window.matchMedia('(max-width: 768px)').matches) {
      setupMobileEuropeanDateInputs();
      bsUpdateMobileDateDisplays();
    }
  });
}
...
function initializeEventListeners() {
  ...
  if (resetFlightBtn) {
    resetFlightBtn.addEventListener('click', () => {
      ...
      if (typeof bsUpdateMobileDateDisplays === 'function') bsUpdateMobileDateDisplays();
...
function handleFlightButtonClick(e) {
  ...
  if (url) {
    ...
    if (service === 'google-flights') {
      try { sessionStorage.setItem('bs-scroll-award', '1'); } catch (_) {}
...
async function handleHotelButtonClick(e) {
  ...
  // On mobile, some browsers block popups if window.open is called only after async work.
  // To avoid this, we pre-open a blank tab on mobile for services that need geocoding,
  // then navigate that tab once geocode is finished.
  const servicesNeedingGeocode = [
    'pointsyeah-hotels',
    'rovemiles-hotels',
  ...
  if (needsGeocode && isMobileViewport) {
    try {
...
function generateFlightUrl(service, data) {
  ...
  const googleFlightsUrl = `https://www.google.com/travel/flights/search?q=${encodeURIComponent(qString).replace(/%20/g, '+')}&hl=${language}&curr=${currency}&gl=${location}&bs-scroll-award=1`;
...
function createHotelTransferModal() {
  ...
  box.innerHTML = `
    ...
    <div class="bs-transfer-modal-body">
      <div class="bs-transfer-controls">
        ...
        <div class="bs-transfer-col-row">
          ...
          <div class="bs-transfer-col-toggles">
            ...
            <label><input type="checkbox" class="bs-transfer-col-toggle" data-column="bilt"> Bilt</label>
            <label><input type="checkbox" class="bs-transfer-col-toggle" data-column="wellsFargo"> Wells Fargo</label>
      ...
      <div class="bs-transfer-table-wrap">
        <table class="bs-transfer-table bs-transfer-table-sortable bs-hide-col-bilt bs-hide-col-wellsFargo">
          <thead>
            <tr>
  ...
  const HOTEL_COL_KEYS = ['amex', 'chase', 'citi', 'capOne', 'bilt', 'wellsFargo', 'rove'];
  const HOTEL_COL_INDEX_MAP = { partner: 0, amex: 1, chase: 2, citi: 3, capOne: 4, bilt: 5, wellsFargo: 6, rove: 7 };
  function applyHotelVisibility() {
    ...
    const selectedCols = table ? HOTEL_COL_KEYS.filter(key => !table.classList.contains('bs-hide-col-' + key)) : HOTEL_COL_KEYS;
    tbody.querySelectorAll('tr').forEach(tr => {
      ...
      selectedCols.forEach(key => {
        const idx = HOTEL_COL_INDEX_MAP[key];
        const cell = tr.cells[idx];
        const span = cell && cell.querySelector('span[data-ratio]');
        const ratio = span && (span.getAttribute('data-ratio') || '').trim();
        if (ratio) hasRatioInSelectedColumn = true;
      });
      ...
      tr.style.display = hasRatioInSelectedColumn && matchFilter && matchSearch ? '' : 'none';
    });
    const countsEl = modal && modal.querySelector('.bs-transfer-counts');
  ...
  const modalForTogglesHotel = box.closest('.bs-transfer-modal-backdrop');
  const togglesWrapHotel = modalForTogglesHotel && modalForTogglesHotel.querySelector('.bs-transfer-col-toggles');
  if (togglesWrapHotel) {
    togglesWrapHotel.querySelectorAll('.bs-transfer-col-toggle').forEach(check => {
      check.addEventListener('change', applyHotelVisibility);
    });
  }
  const thead = table && table.querySelector('thead tr');
...
function createFlightTransferModal() {
  ...
  const tbody = box.querySelector('.bs-transfer-table tbody');
  const filterWrap = box.querySelector('.bs-transfer-filter-wrap');
  const AIRLINE_COL_KEYS = ['amex', 'chase', 'citi', 'capOne', 'bilt', 'wellsFargo', 'rove'];
  const AIRLINE_COL_INDEX_MAP = { partner: 0, amex: 1, chase: 2, citi: 3, capOne: 4, bilt: 5, wellsFargo: 6, rove: 7 };
  function applyAirlineVisibility() {
    ...
    const activeFilterBtn = wrap && wrap.querySelector('.bs-transfer-filter-btn.active');
    const filterValue = (activeFilterBtn && activeFilterBtn.getAttribute('data-filter')) || '';
    const selectedCols = table ? AIRLINE_COL_KEYS.filter(key => !table.classList.contains('bs-hide-col-' + key)) : AIRLINE_COL_KEYS;
    tbody.querySelectorAll('tr').forEach(tr => {
      if (tr.classList.contains('bs-transfer-loading-row')) {
        tr.style.display = filterValue ? 'none' : '';
        return;
      ...
      let hasRatioInSelectedColumn = false;
      selectedCols.forEach(key => {
        const idx = AIRLINE_COL_INDEX_MAP[key];
        const cell = tr.cells[idx];
        const span = cell && cell.querySelector('span[data-ratio]');
        const ratio = span && (span.getAttribute('data-ratio') || '').trim();
        if (ratio) hasRatioInSelectedColumn = true;
  ...
  const table = box.querySelector('.bs-transfer-table');
  bindTransferColumnToggles(table);
  const modalForToggles = box.closest('.bs-transfer-modal-backdrop');
  const togglesWrap = modalForToggles && modalForToggles.querySelector('.bs-transfer-col-toggles');
  if (togglesWrap) {
    togglesWrap.querySelectorAll('.bs-transfer-col-toggle').forEach(check => {
      check.addEventListener('change', applyAirlineVisibility);
    });
  }
  const thead = table && table.querySelector('thead tr');
