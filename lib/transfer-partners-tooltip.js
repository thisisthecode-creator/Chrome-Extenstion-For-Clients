...
function renderSelectedCards() {
  ...
  // Get initial display type from localStorage
  const initialDisplayType = localStorage.getItem('bs-selected-cards-display-type') === 'cashback' ? 'cashback' : 'points';
...
function renderAvailableTransferPartners(displayType = 'ratio') {
  ...
  // Get saved display type or default to 'ratio'
  const savedDisplayType = localStorage.getItem('transfer-partners-display-type') || 'ratio';
