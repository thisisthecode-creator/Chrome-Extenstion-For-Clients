 ...
 * - Fetches data from OpenFlights database (14,000+ airports)
...
class AirportDataService {
  ...
  /**
   * Fetch airport data from OpenFlights database
  ...
  /**
   * Internal method to load airport data from OpenFlights
   * @private
   */
